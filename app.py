...
app = Flask(__name__) # creates a flask app.. write anything instead of __name__

#print (__name__)

FB_ACCESS_TOKEN = os.environ.get('fb_token')
bot = Bot(FB_ACCESS_TOKEN)# class of pymessenger library
...
def webhook(): # to connect fb with our own server 
	print('request is :\n')
	print(request.data)
	print ('\n\n\n\n')
